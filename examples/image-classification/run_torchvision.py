...
def main():
    ...
    # Get Wide-ResNet variant. But it doesn't really have to be Wide-ResNet.
    # Any torchvision model should work fine.
    ...
    # Set to a large shard count so that we can try to make pipeline partitions
